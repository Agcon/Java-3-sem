package ru.agcon.new_labs.laba14;
...
public class Main{
    ...
    public static void main(String[] args) {
        ...
        System.out.println(thirdTask("104.009 EU"));
    ...
    public static void firstTask(String stForSplit) {
        ...
        String[] var2 = splitString;
        int var3 = splitString.length;
    ...
    public static void eighthTask(String[] array) {
        String[] newArray = (String[])filter(array, new Main.Filter() {
    ...
    public static Object[] filter(Object[] array, Main.Filter filter) {
        int iDeletedCount = 0;
    ...
    public static void ninethTask(String stTaskNine) {
        ...
        System.out.println("Map: " + String.valueOf(dictionary));
    }

    interface Filter {
        boolean apply(Object var1);
    }
}
