...
import ru.agcon.new_labs.laba22.zadanie1.DivisionByZeroException;
import ru.agcon.new_labs.laba22.zadanie1.EmptyStackException;

public class Controller extends JFrame {
    public Controller() {
        super("calculator");
        this.setSize(200, 300);
        final View view = new View((JPanel)this.getContentPane());
            ...
            public void actionPerformed(ActionEvent e) {
                if (e.getActionCommand().charAt(0) == '=') {
                    ...
                    try {
                        ...
                        Controller.this.clear(model, view);
